...
This repository is intended as a complement to the article: "Behaviour Cloning for Online Learning of Driver Habits", and contains the code related to the shown results.
